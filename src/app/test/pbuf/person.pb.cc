...
const char descriptor_table_protodef_person_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014person.proto\022\006PERSON\"Z\n\006Person\022\021\n\004name"
...
const ::_pbi::DescriptorTable descriptor_table_person_2eproto = {
    false, false, 122, descriptor_table_protodef_person_2eproto,
    "person.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "PERSON.Person.name"));
        } else
          goto handle_unusual;
        continue;
      // optional int32 id = 2;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "PERSON.Person.email"));
        } else
          goto handle_unusual;
        continue;
      default:
